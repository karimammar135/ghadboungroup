      ...
      <section className='' id="contactus">
        ...
        <div className='flex justify-center items-center pl-[20px] pr-[20px] pt-[60px] pb-[60px]'>
          <div id="location" className='w-full max-w-[1245px] sm:w-4/5 flex flex-col items-center gap-[10px]'>
            ...
            <iframe className='border-0 rounded w-full mt-[15px] bg-[#4E443C]' height="350" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11689.927197891893!2d35.29021192372544!3d33.2086157894989!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151e8155d5bc2851%3A0x95a1777b0c1e4476!2sQana!5e0!3m2!1sen!2slb!4v1714259024442!5m2!1sen!2slb" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </section>
    </SkeletonTheme>
